...
namespace SolarRadiationStore.Lib.Migrations
{
    ...
    [Migration("20200914031106_modify forecast FK to include location")]
    partial class modifyforecastFKtoincludelocation
    {
            ...
            modelBuilder.Entity("SolarRadiationStore.Lib.DbSolradForecast", b =>
                {
                    ...
                    b.HasKey("LocationForecastId", "PeriodEnd", "Period");

                    b.HasIndex("LocationForecastsId");

                    b.ToTable("DbSolradForecast");
                });
